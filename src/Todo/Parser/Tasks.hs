...
import Todo.Parser.Atoms (whiteSpace)
...
parseLines :: String -> String -> Either P.ParseError [Tasks.Task]
...
validateLine :: String -> Either P.ParseError Tasks.Task
